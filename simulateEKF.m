function [states_OUT, cov_OUT] = simulateEKF(accelerations,omega,ALP,BET,u,Vt,H)
...
if isempty(states)
    ...
    states(20,1) = 1;           cov(20,20) = 1e-3^2;
    
    states(21,1) = 1;           cov(21,21) = 1e-3^2;
    states(22,1) = 1;           cov(22,22) = 1e-3^2;
    states(23,1) = 1;           cov(23,23) = 1e-3^2;
    states(24,1) = 1;           cov(24,24) = 1e-3^2;
    
    states(25,1) = 1;           cov(25,25) = 1e-3^2;
    states(26,1) = 1;           cov(26,26) = 1e-3^2;
    states(27,1) = 1;           cov(27,27) = 1e-3^2;
    states(28,1) = 1;           cov(28,28) = 1e-3^2;
    states(29,1) = 1;           cov(29,29) = 1e-3^2;
    states(30,1) = 1;           cov(30,30) = 1e-3^2;
