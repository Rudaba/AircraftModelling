...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_aircraftControl_smallerStateEKF_process_check_sum_call(
    int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_aircraftControl_smallerStateEKF_process_check_sum_call(nlhs,plhs,nrhs,
       prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_aircraftControl_smallerStateEKF_autoinheritance_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "aircraftControl_smallerStateEKF") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_aircraftControl_smallerStateEKF_autoinheritance_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int sf_aircraftControl_smallerStateEKF_third_party_uses_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "aircraftControl_smallerStateEKF") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_aircraftControl_smallerStateEKF_third_party_uses_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int
    sf_aircraftControl_smallerStateEKF_updateBuildInfo_args_info( int nlhs,
  ...
  if (strcmp(machineName, "aircraftControl_smallerStateEKF") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_aircraftControl_smallerStateEKF_updateBuildInfo_args_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_aircraftControl_smallerStateEKF_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
  ...
  if (strcmp(machineName, "aircraftControl_smallerStateEKF") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_aircraftControl_smallerStateEKF_get_eml_resolved_functions_info
      (nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_aircraftControl_smallerStateEKF_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"aircraftControl_smallerStateEKF")) {
    return(sf_aircraftControl_smallerStateEKF_method_dispatcher(simstructPtr,
...
extern void aircraftControl_smallerStateEKF_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    aircraftControl_smallerStateEKF_terminator();
...
extern void aircraftControl_smallerStateEKF_initializer(void);
extern void aircraftControl_smallerStateEKF_register_exported_symbols(SimStruct*
  S);
extern void aircraftControl_smallerStateEKF_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  aircraftControl_smallerStateEKF_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      aircraftControl_smallerStateEKF_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    aircraftControl_smallerStateEKF_initializer();
  }
